...
@section('main-section')
    ...
    <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">Transaction <span
                    style="text-transform: uppercase;"><?php echo $type; ?></span></h2>
            <ol class="breadcrumb">
        ...
        <div class="btn btn-list">
            <button type="button" class="btn btn-outline-primary rounded" id="toggler" data-toggle="modal"
                data-target="#add_transaction_modal">
                Add Transaction
            </button>
            <div id="add_transaction_modal" class="modal fade" role="dialog" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ url('submit_transaction') }}" class="ajax-form-submit" id="cform"
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label class="d-flex" for="dr_party">DR Party<span
                                                                    class="tx-danger">*</span></label>
                                                            <select class="form-control dr_select2" onchange="drparty(this)"
                                                                name="dr_party" id="dr_party" required>
                                                                <option value=""></option>
                                                            </select>
                                                            <span
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label class="float-left" for="dr_amount">DR Party Amount<span
                                                                    class="tx-danger">*</span></label>
                                                            <input type="text" class="form-control" id="dr_amount"
                                                                name="dr_amount" readonly required>
                                                            <span
                                                                class="float-left tx-danger error_text dr_amount_error"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label class="d-flex" for="cr_party">CR Party<span
                                                                    class="tx-danger">*</span></label>
                                                            <select class="form-control cr_select2" onchange="crparty(this)"
                                                                name="cr_party" id="cr_party" required>
                                                                <option value=""></option>
                                                            </select>
                                                            <span
                                                                class="float-left tx-danger error_text cr_party_error"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label class="float-left" for="cr_amount">CR Party Amount<span
                                                                    class="tx-danger">*</span></label>
                                                            <input type="text" class="form-control" id="cr_amount"
                                                                name="cr_amount" readonly required>
                                                            <span
                                                                class="float-left tx-danger error_text cr_amount_error"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            <label class="float-left" for="tras_amount">Transfer Amount<span
                                                                    class="tx-danger">*</span></label>
                                                            <input type="number" class="form-control" id="tras_amount"
                                                                name="tras_amount" required>
                                                            <span
                                                                class="float-left tx-danger error_text tras_amount_error"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.st == 'success') {
                        var bookName = "{{ env('BOOK_NAME') }}";
                        var swal_html = `
                        <div id="copySuccessAlert" class="alert alert-success" style="display: none;">Table content copied successfully!</div>
                        ...
                        <div style="text-align:-webkit-center;font-size:15px; display: flex;justify-content: start;margin-top: 22px;">
                            <i class="fa-solid fa-copy" style="cursor:pointer; color:green; margin-right:20px; font-size:20px;" onclick="copyTable('table1')"></i>
                            <div id="table1">
                                <table border="1">
                                    ...
                                    <tr><td style="padding:10px;">Dr Party</td><td style="padding:10px;">:</td><td style="padding:10px;">${response.msg.dr_party}</td><td style="text-align:right;">${response.msg.amount}</td></tr>
